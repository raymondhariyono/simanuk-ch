...
class CreateDetailPeminjamanPrasaranaTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->addKey('id_detail_prasarana', true);
        ...
        $this->forge->createTable('detail_peminjaman_prasarana');
    }

    public function down()
    {
        $this->forge->dropTable('detail_peminjaman_prasarana');
    }
}
