   ...
   <?php if (isset($overdueCount) && $overdueCount > 0) : ?>
      <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded shadow-sm animate-pulse">
         <div class="flex">
            ...
            <div class="ml-3">
               <h3 class="text-sm font-bold text-red-800">Akun Ditangguhkan Sementara!</h3>
               <div class="mt-1 text-sm text-red-700">
                  <p>
                     Terdapat <strong><?= $overdueCount ?> peminjaman</strong> yang belum dikembalikan lebih dari <strong>3 hari</strong> melewati tenggat waktu.
                     Fitur pengajuan peminjaman baru dinonaktifkan hingga barang dikembalikan.
                  </p>
               </div>
            </div>
         </div>
