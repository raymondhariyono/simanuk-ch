...
<script>
   ...
   document.addEventListener("DOMContentLoaded", function() {
      ...
      // Jika URL ada ?page_prasarana=X, otomatis buka tab prasarana
   ...
   function switchTab(tabName) {
      ...
      if (tabName === 'sarana') {
         ...
         btnPrasarana.className = "inline-block p-4 border-b-2 rounded-t-lg group transition-all duration-300 text-blue-600 border-blue-600 active"; // Custom warna ungu untuk prasarana
