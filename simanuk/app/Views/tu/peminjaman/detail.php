      ...
      <div class="space-y-6">
         ...
         <div class="bg-white shadow rounded-lg p-6">
            ...
            <?php if ($peminjaman['status_peminjaman_global'] == 'Diajukan') : ?>
               <div class="space-y-3">
                  <form action="<?= site_url('tu/peminjaman/approve/' . $peminjaman['id_peminjaman']) ?>" method="post" onsubmit="return confirm('Setujui peminjaman ini? Stok sarana akan berkurang otomatis.')">
                     <?= csrf_field() ?>
                  ...
                  <div id="rejectForm" class="hidden mt-4 bg-gray-50 p-3 rounded border">
                     <form action="<?= site_url('tu/peminjaman/reject/' . $peminjaman['id_peminjaman']) ?>" method="post">
                        <?= csrf_field() ?>
            ...
            <?php else: ?>
               <div class="text-center text-sm text-gray-500 mt-4">
                  <p>Peminjaman ini sudah diproses oleh TU.</p>
               </div>
            <?php endif; ?>
         </div>
