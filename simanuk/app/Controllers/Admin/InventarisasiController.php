...
class InventarisasiController extends BaseController
{
   ...
   public function create()
   {
      ...
      return view('admin/inventaris/create_view', $data);
   }
   ...
   public function save()
   {
      ...
      // Ambil semua data spesifikasi sebagai array.
      // Ini mengasumsikan form mengirim input dengan nama seperti "spesifikasi[merk]", "spesifikasi[warna]", dll.
      $spesifikasi = $this->request->getPost('spesifikasi') ?? [];
      // Filter untuk menghapus field spesifikasi yang kosong
